# TBUtil 2.0g Quick Install Guide.
...
Once downloaded, un-zip the file into a directory of your choice. For example (for version 2.0g, Linux)...

```
$ cd $HOME
$ unzip $HOME/Downloads/tbutil-2_0g-linux.zip    (or the location you have copied the zip file to)
```
