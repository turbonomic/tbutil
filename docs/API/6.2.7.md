# REST API Reference (For Turbonomic 6.2.7)


Date: Tue, 03 Aug 2021 23:07:34 BST
...
JavaScript Usage ...
	...
	result = client.deleteActiveDirectoryGroup(adGroup_Name)

REST method and path ...

	DELETE /users/ldap/groups/{adGroup_Name}
...
Body DTO: [BusinessUnitDiscountApiDTO](#businessunitdiscountapidto)

Return DTO: [BusinessUnitDiscountApiDTO](#businessunitdiscountapidto)
...
Get the base rates per datacenter for given template within business unit and specified pricing model

JavaScript Usage ...

	result = client.getPrices(template_Uuid [,_opts])
...
| Option | Required? | Type | Description | Values |
|--------|-----------|------|-------------|--------|
| **businessunit** | Yes | string | The Uuid of a business unit | - |
| **cloudservice** | Yes | string | The Uuid of a cloud service | - |
| **pricing_model** | Yes | string | Pricing model, can be ON_DEMAND, RESERVED, SPOT | ON_DEMAND, RESERVED, SPOT |
...
| `businessUnitType` | string | No | Type of the business unit instance | BUDGET, DISCOUNT, DISCOVERED |
...
## BusinessUnitDiscountApiDTO

Discount values for cloud services and templates related to a business unit. The discounts configured on an user-defined business unit apply to cloud services and templates offered by the children business units.

| Property | Type | Required? | Description | Enum Values |
| -------- | ---- | --------- | ----------- | ----------- |
| `serviceDiscounts` | [CloudServiceDiscountApiDTO](#cloudservicediscountapidto)[] | No | Discount information for the related cloud services and templates. | - |
...
Discounts for cloud service and related templates specified for a certain pricing model.
...
| `templateDiscounts` | [TemplateDiscountDTO](#templatediscountdto)[] | No | Discount values for the templates offered by the cloud service under certain pricing model. | - |
| `uuid` | string | No | - | - |
...
| `displayName` | string | No | - | - |
| `family` | string | No | VM instance family, e.g m3, used for cloud templates. | - |
...
Discount information for a template within a business unit and specified pricing model.
