# REST API Reference (For Turbonomic 7.17.0)


Date: Tue, 03 Aug 2021 23:12:33 BST
...
| `actionState` | string | No | State | ACCEPTED, CLEARED, DISABLED, FAILED, IN_PROGRESS, PENDING_ACCEPT, QUEUED, RECOMMENDED, REJECTED, SUCCEEDED |
