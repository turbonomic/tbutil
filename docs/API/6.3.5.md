# REST API Reference (For Turbonomic 6.3.5)


Date: Tue, 03 Aug 2021 23:08:22 BST
...
| `placementStatusMessage` | string | No | Details of placement during failure or success | - |
