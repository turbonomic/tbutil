# REST API Reference (For Turbonomic 7.12.0)


Date: Tue, 03 Aug 2021 23:12:29 BST
...
| **sql_file_contents** | Yes | org.springframework.web.multipart.MultipartFile | The custom .sql file. Accepts only 1 `file` parameter | - |
...
JavaScript Usage ...
	...
	result = client.createIdpMetadata([_opts])
...
| Option | Required? | Type | Description | Values |
|--------|-----------|------|-------------|--------|
| **file** | Yes | ref | The IDP metadata file.  Accepts multiple `file`. | - |
...
JavaScript Usage ...
	...
	result = client.createKeyStoreFromMultipartFiles([_opts])
...
| Option | Required? | Type | Description | Values |
|--------|-----------|------|-------------|--------|
| **file** | Yes | ref | The key store file. Accepts multiple `file`. | - |
...
JavaScript Usage ...
	...
	result = client.deleteProbeSpecificProperty(probeId, name)
...
JavaScript Usage ...
	...
	result = client.deleteTargetSpecificProperty(probeId, targetId, name)
...
JavaScript Usage ...
	...
	result = client.editRateCard(priceList_Uuid, _body)

REST method and path ...

	PUT /pricelists/{priceList_Uuid}
...
JavaScript Usage ...
	...
	result = client.getInternalState()

REST method and path ...

	GET /internal-state

Return DTO: [ByteArrayResource](#bytearrayresource)
...
Gets detailed information for the specified role
...
JavaScript Usage ...
	...
	result = client.getStatsByEntityQuery(entity_Uuid, _body)
...
JavaScript Usage ...
	...
	result = client.getStatsByEntityUuid(entity_Uuid [,_opts])
...
JavaScript Usage ...
	...
	result = client.getTemplatesByTypeOrUuid(template_UuidOrType)

REST method and path ...

	GET /templates/{template_UuidOrType}
...
JavaScript Usage ...
	...
	result = client.loggingEntities(entity_Uuids)
...
JavaScript Usage ...
	...
	result = client.putProbeSpecificProperty(probeId, name, _body)
...
JavaScript Usage ...
	...
	result = client.putTargetSpecificProperty(probeId, targetId, name, _body)
...
JavaScript Usage ...
	...
	result = client.restoreInternalState(_body)

REST method and path ...

	POST /internal-state

Body DTO: [ByteArrayResource](#bytearrayresource)

Return DTO: [string](#string)

## SetDBRootPassword

Sets DB root password

JavaScript Usage ...

	result = client.setDBRootPassword(_body)

REST method and path ...

	PUT /dbadmin/setDBRootPassword

Swagger tags ...

- dbadmin

Body DTO: [DBPasswordDTO](#dbpassworddto)
...
| **rateCardFile** | Yes | org.springframework.web.multipart.MultipartFile | The custom rate card file. Accepts only 1 `file` parameter | - |
